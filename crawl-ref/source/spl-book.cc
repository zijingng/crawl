                                  ...
                                  bool memorise_only = true)
{
    ...
    for (const spell_type spell : available_spells)
    {
        ...
        {
            num_known++;
            // Divine Knowledge wants to consider spells the player already
            // knows.
...
private:
    ...
    void update_more()
    {
        ...
        const string act = you.divine_knowledge ? "Cast" : "Memorise";
        // line 2
        ...
        case CK_TOUCH_DUMMY:
            ...
            switch (current_action)
            {
                ...
                case action::hide:
                    ...
                    break;
                case action::unhide:
                    current_action = you.divine_knowledge ? action::cast
                                                          : action::memorise;
                    entries_changed = true;
                    break;
            }
...
public:
    SpellLibraryMenu(spell_list& list)
        ...
        current_action(you.divine_knowledge ? action::cast : action::memorise),
        spells(list),
        hidden_count(0)
    {
